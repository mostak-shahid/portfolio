...
$class = $portfolio_options['sections-widgets-class'];
$title = $portfolio_options['sections-widgets-title'];
$content = $portfolio_options['sections-widgets-content'];
$widget_layout = $portfolio_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" class="<?php if(@$portfolio_options['sections-widgets-background-type'] == 1) echo @$portfolio_options['sections-widgets-background'] . ' ';?><?php if(@$portfolio_options['sections-widgets-color-type'] == 1) echo @$portfolio_options['sections-widgets-color'];?> <?php echo $class ?>">
