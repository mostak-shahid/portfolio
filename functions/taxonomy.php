<?php
// hook into the init action and call moswork_taxonomies when it fires
add_action( 'init', 'moswork_work_taxonomies', 0 );

// create two taxonomies, categories and tags for the post type "book"
function moswork_work_taxonomies() {
	...
	register_taxonomy( 'tag', 'work', $args );
}