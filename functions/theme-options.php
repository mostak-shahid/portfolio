<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                ...
                'mode'     => 'css',
                'theme'    => 'monokai',
                //'desc'     => 'Possible modes can be found at <a href="' . 'http://' . 'ace.c9.io" target="_portfolio">' . 'http://' . 'ace.c9.io/</a>.',
                //'default'  => "body{\n   margin: 0 auto;\n}"
            ),
            array(
                'id'       => 'misc-settings-js',
        ...
        'fields'     => array(
            ...
            array(
                ...
                'placeholder' => array(
                    ...
                    'link_title'         => __( 'Rating without %', 'redux-framework-demo' ),
                )
            ),
            array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'placeholder' => array(
                    ...
                    'link_url'         => __( 'Icon', 'redux-framework-demo' ),
                )
            ),
            array(
    ...
    //Recent Works
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Recent Works', 'redux-framework-demo' ),
        'id'               => 'sections-work',
        'subsection'       => true,
        'desc'             => '',
        'customizer_width' => '450px',
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'sections-work-list',
                'type'     => 'select',
                // 'data'     => 'post_type',
                'multi'    => true,
                'sortable' => true,
                'title'    => __( 'Select Works', 'redux-framework-demo' ),
                'options'  => mos_post_details('work'),
            ),
            array(
                'id'       => 'sections-work-link',
                'type'     => 'mos_group',                
                'title'    => 'Link',
                'show' => array (
                    'text_field_1' => true,
            ...
            array(
                ...
                'required' => array( 'sections-work-color-type', '=', '1' ),
            ),
            array(
                'id'       => 'sections-work-color-rgba',
                'type'     => 'color_rgba',
                'title'    => __( 'Select Color', 'redux-framework-demo' ),
                'validate' => 'colorrgba',
                'required' => array( 'sections-work-color-type', '=', '2' ),
                'output'         => array( '#section-work' ),
                'mode'     => 'color',
                'validate' => 'colorrgba',
            ),
            array(
                'id'       => 'sections-work-link-color',
                'type'     => 'link_color',
                'title'    => __('Links Color Option', 'redux-framework-demo'),
                'validate' => 'color',
                'output'         => array( '#section-work a' ),
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                ...
                'type'     => 'text',
                'title'    => __( 'Section Form Shortcode', 'redux-framework-demo' ),
                'desc'     => 'You can add form shortcode here.',
                'validate'     => 'no_html',
            ),
            array(
    ...
    if ( ! function_exists( 'dynamic_section' ) ) {
        function dynamic_section( $sections ) {
            ...
            $sections[] = array(
                ...
                // Leave this as a portfolio section, no options just some intro text set above.
                'fields' => array()
            );
