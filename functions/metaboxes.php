...
function portfolio_metaboxes() {
    $prefix = '_portfolio_';
    global $portfolio_options,$template_parts;
    $blog_id = get_option( 'page_for_posts' );
    if ($_GET['post'] == $blog_id){
        $enabled = ($portfolio_options['archive-page-sections']['Enabled']) ? $portfolio_options['archive-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($portfolio_options['archive-page-sections']['Disabled']) ? $portfolio_options['archive-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
    else{
