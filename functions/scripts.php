...
function portfolio_enqueue_scripts() {
	...
	if ($portfolio_options['basic-styling-stylesheet']) {
		wp_register_style( $portfolio_options['basic-styling-stylesheet'], get_template_directory_uri() .  '/css/'.$portfolio_options['basic-styling-stylesheet'].'.css', array('main.min'));
		wp_enqueue_style( $portfolio_options['basic-styling-stylesheet'] );		
	}
